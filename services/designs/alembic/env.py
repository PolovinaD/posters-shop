"""
Alembic Environment Configuration for Designs Service
...
from models import Generation, SavedPrompt, StyleProfile, Purchase, ProcessedEvent, SCHEMA_NAME  # noqa: F401
