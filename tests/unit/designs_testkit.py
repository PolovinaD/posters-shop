...
MODULES = ["logger", "service_auth", "auth", "models", "circuit_breaker", "providers", "summarizer", "storage", "quota", "schemas", "worker", "catalog_client", "inventory_client", "printing", "main"]
_cache = None
