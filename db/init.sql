...
CREATE USER designs_svc WITH PASSWORD 'designs_pass';
...
DO $$
BEGIN
  EXECUTE format('GRANT CREATE ON DATABASE %I TO users_svc, catalog_svc, orders_svc, production_svc, logistics_svc, inventory_svc, notifications_svc, designs_svc', current_database());
END $$;
